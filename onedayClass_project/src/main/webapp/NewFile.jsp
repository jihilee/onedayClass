...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/bootStrap/custom1.css">
    <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/bootStrap/custom2.css">
    <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/bootStrap/custom3.css">
    <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/bootStrap/custom4.css">
    <!-- Global Site Tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-23019901-1"></script>
    <script>https://bootswatch.com/_vendor/prismjs/prism.js
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" id="download">United</a>
              <div class="dropdown-menu" aria-labelledby="download">
                <a class="dropdown-item" rel="noopener" target="_blank" href="https://jsfiddle.net/bootswatch/1d0z57y6/">Open in JSFiddle</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="../5/united/bootstrap.min.css" download>bootstrap.min.css</a>
                <a class="dropdown-item" href="../5/united/bootstrap.css" download>bootstrap.css</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="../5/united/_variables.scss" download>_variables.scss</a>
                <a class="dropdown-item" href="../5/united/_bootswatch.scss" download>_bootswatch.scss</a>
              </div>
            </li>
          </ul>
