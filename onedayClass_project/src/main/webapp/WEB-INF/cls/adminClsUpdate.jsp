        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 col-xl-6 text-center">
                    <h3 id="containers"><b>클래스 수정</b></h3>
                    <hr class="divider" />
                </div>
            </div>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                <div class="col-lg-6">
            <form id="adminClsUpdate" action="adminClsUpdate.cls" method="post" enctype="multipart/form-data">
            	<input type="hidden" name="cnum" value="${cb.cnum }">
            	 
			  <div class="form-group">
                <label for="cname" class="form-label mt-4">클래스명</label>
                <input type="text" class="form-control" id="cname" name="cname" value="${cb.cname }">
              </div>
			  <div class="form-group">
                <label for="ctime" class="form-label mt-4">소요시간</label>
                <input type="text" class="form-control" id="ctime" name="ctime" value="${cb.ctime }">
              </div>
              <div class="form-group">
                <label for="cprice" class="form-label mt-4">가격</label>
                <input type="text" class="form-control" name="cprice" value="${cb.cprice }">
              </div>
           	  <div class="form-group">
                 <label for="cinfo" class="form-label mt-4">클래스정보1</label>
                 <textarea class="form-control" id="cinfo" rows="3" name="cinfo">${cb.cinfo }</textarea>
              </div>
           	  <div class="form-group">
                 <label for="ccontent" class="form-label mt-4">클래스정보2</label>
                 <textarea class="form-control" id="ccontent" rows="5" name="ccontent"> ${cb.ccontent } </textarea>
              </div>
              <div class="form-group">
                 <label for="upload1" class="form-label mt-4">이미지1</label>
             	 <input type="file" class="form-control"  name="upload1">
             	 <input type="text" readonly class="form-control-plaintext" name="gu_cimage1" value="${cb.cimage1 }">
              </div>
              <div class="form-group">
                 <label for="upload2" class="form-label mt-4">이미지2</label>
             	 <input type="file" class="form-control"  name="upload2">
             	 <input type="text" readonly class="form-control-plaintext" name="gu_cimage2" value="${cb.cimage2 }">
              </div>
              <div class="form-group">
                 <label for="upload3" class="form-label mt-4">이미지3</label>
             	 <input type="file" class="form-control"  name="upload3">
             	 <input type="text" readonly class="form-control-plaintext" name="gu_cimage3" value="${cb.cimage3 }">
              </div>
			  <div class="form-group">
			  <br><br>
