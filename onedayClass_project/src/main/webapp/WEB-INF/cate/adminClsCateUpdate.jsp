...
<script type="text/javascript">
	$('document').ready(function(){
		...
		$('#catedul').click(function(){
			...
			var gu_bcate = $('input[name="gu_bcate"]').val();
...
<div class="bs-docs-section">
	...
	<div class="col-lg-12">
		<div class="bs-component">
		 ...
		 <form action="adminClsCateUpdate.cate" method="post" align="center" enctype="multipart/form-data">
		 	<input type="hidden" name="bcatenum" value="${cateBean.bcatenum}">
		 	<input type="hidden" name="gu_bcate" id="gu_bcate" value="${cateBean.bcate }">
			 	...
			 	<th class="table-active">대분류명</th> 
					<td>
						<div class="col-lg-8">
							...
							<input type="text" class="form-control" name="bcate" value="${cateBean.bcate }">
