	...
	<section style="margin-top:100px;">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="searchPw.mb" method="post">
                            ...
                            <div class="d-grid"><button class="btn btn-primary btn-xl" id="submitButton" type="submit">비밀번호 찾기</button></div>
                        </form>
                    </div>
                </div>
            </div>
