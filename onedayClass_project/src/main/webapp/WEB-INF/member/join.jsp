	...
	<section style="margin-top:100px;">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                <form id="joinForm" action="join.mb" method="post">
				  ...
				  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <button class="btn btn-primary" type="button" id="idbtn">확인</button>
                    </div>
                    <span id="result"></span>
                  </div>
                  <div class="form-group">
                  ...
                  <br>
				  <div class="form-group">
                    <input type="submit" class="btn btn-primary" id="submitButton" style="width:100%" value="가입">
                  </div>
